...
//        strategy.setSuperEntityClass("com.baomidou.ant.common.BaseEntity");//实体类

        strategy.setEntityLombokModel(true);//使用lombok

        strategy.setRestControllerStyle(true);//controller的style
        // 公共父类
...
//        strategy.setVersionFieldName("flag");//乐观锁

        strategy.setLogicDeleteFieldName("flag");//逻辑删除

        strategy.setControllerMappingHyphenStyle(false);//驼峰转连字符关闭

//        strategy.setTablePrefix(pc.getModuleName() + "_");

        if (org.apache.commons.lang3.StringUtils.isNotBlank(tablePrefix)) {
            strategy.setTablePrefix(tablePrefix + "_");//表前缀
        }
